 ...
 * January 20, 2019
 * This class is used as a template to create a menu screen that will lead to the actual game when the start button is clicked.
 */
...
class StartingFrame extends JFrame { 
  ...
  StartingFrame() { 
    ...
    startButton.addActionListener(new StartButtonListener());
     ...
     //Create a JButton for the centerPanel
    JLabel startLabel = new JLabel("Welome to Infinity Dungeon...");
